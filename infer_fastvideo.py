...
sys.path.insert(0, "/raid/fga/video-gen-related/FastVideo")
...
OUTPUT_PATH = "/raid/fga/video-gen-related/outputs/fastvideo_8step"
# =========================
...
def main():
    model_id = "/raid/fga/video-gen-related/CausalWan2.2-I2V-A14B-Preview-Diffusers"
